"""reformatted schema, model

Revision ID: 80de2652333e
Revises: 9edcd2cc8586
Create Date: 2025-05-23 13:11:07.877492
...
revision: str = '80de2652333e'
down_revision: Union[str, None] = '9edcd2cc8586'
...
def upgrade() -> None:
    ...
    op.add_column('jobs', sa.Column('work_type', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('jobs', sa.Column('experience_level', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('jobs', sa.Column('summary', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('jobs', sa.Column('education', sa.VARCHAR(), autoincrement=False, nullable=False))
