"""add optional applied field

Revision ID: 1f08a42832d4
Revises: d858d9b3f1d0
Create Date: 2025-05-21 12:53:33.950379
...
revision: str = '1f08a42832d4'
down_revision: Union[str, None] = 'd858d9b3f1d0'
...
def upgrade() -> None:
    ...
    op.add_column('jobs', sa.Column('job_title', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('jobs', sa.Column('job_url', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.alter_column('jobs', 'applied',
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('jobs', sa.Column('title', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('jobs', sa.Column('link', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.alter_column('jobs', 'applied',
